...
Emoji = List[Union[disnake.Emoji, disnake.Reaction, disnake.PartialEmoji, str]]
...
class Paginator:
    ...
    only : disnake.abc.User, optional
    ...
    def __init__(
        ...
        only: Optional[disnake.abc.User] = None,
        ...
        if (
            isinstance(bot, disnake.Client)
            or isinstance(bot, disnake.AutoShardedClient)
            or isinstance(bot, commands.Bot)
            or isinstance(bot, commands.AutoShardedBot)
        ):
            pass
        elif (
            issubclass(bot, disnake.Client)
            or issubclass(bot, disnake.AutoShardedClient)
    ...
    def emoji_check(self, payload: disnake.RawReactionActionEvent) -> bool:
    ...
    async def handle_pagination(self, emoji: disnake.PartialEmoji) -> None:
        if self.use_extend:
